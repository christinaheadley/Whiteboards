Exercise: Work on the following problems in groups of three. (Take turns on doing each one.)
Be sure to follow the process outlined in the cheat sheet!
Do each problem the long way, avoid Ruby methods that solve the problem for you (like .sort, .reverse, etc.)
